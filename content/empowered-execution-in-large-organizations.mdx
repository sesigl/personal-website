...
[^1]: Pulse of the Profession 2015: Capturing the Value of Project Management ([PMI](https://www.pmi.org/)).
[^2]: Google's Data-Driven Insights on High-Performing Teams ([Project Aristotle](https://www.aristotleperformance.com/)).
[^3]: The Skills That Help Employees Adapt: A Four-Category Framework ([PMC](https://pmc.ncbi.nlm.nih.gov)).
[^4]: LSA Global Research Results: Strategic Organizational Alignment ([LSA Global](https://lsaglobal.com)).
[^5]: Understanding Agile Teams: A Systematic Review ([ScienceDirect](https://www.sciencedirect.com/)).
