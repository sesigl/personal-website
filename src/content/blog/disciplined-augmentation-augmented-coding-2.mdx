...
spotifyLink: "https://open.spotify.com/episode/2CMGjF0FcTriVN7pO1p4w5?si=Vfa9G7n6QOWR6GeUakd5qA"
infographicLink: "/images/posts/infographics/why-most-tams-fail-at-ai-coding-agentic-2.png"
---

import { Image } from 'astro:assets';
import twoFuturesHero from '../../images/blog/posts/agentic_coding_2/agentic_coding_2.png';
import defineGenerationRefinment from '../../images/blog/posts/agentic_coding_2/define-generation-refinement.png';
import vibeCoding from '../../images/blog/posts/agentic_coding_2/vibe-coding.png';
...
<center>
<Image src={defineGenerationRefinment} alt="A diagram showing the cycle of defining requirements, generating code, and refining it through human oversight." width={700} />
</center>
...
<center>
<Image src={vibeCoding} alt="A diagram illustrating the iterative, conversational development process where creators describe goals and refine solutions through dialogue with AI systems." width={700} />
</center>
