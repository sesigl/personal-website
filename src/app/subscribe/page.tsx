            ...
            <div className="space-y-10">
              <section>
                ...
                <div className="text-slate-500 dark:text-slate-400 space-y-8">
                  <p className="text-lg">
                    This newsletter is written by Sebastian Sigl, who works at
                    Adevinta and previously worked at eBay and other successful
                    companies. Here is what to expect by subscribing:
                  </p>
